...
for j in range(numtrials): # 
    ...
    if singleconditionsx == 1:
        ...
        p01 = .48#(52/48) PTASK - HARD
    elif singleconditionsx == 4:
        p01 = .44#(56/44) PTASK - HARD
    ...
    # More Orange Trials:
        ...
        p01 = .66 # (66/34) orange EASY
    elif singleconditionsx == 20:
        p01 = .38 # (62/38) a lot of blue EASY
    elif singleconditionsx == 30:
        p01 = .56 # (56/44) a lot of orange HARD
...
for j in range(numtrials): # 
    ...
    if singleconditionsx == 1:
        ...
        p01 = .44#(56/44) JDTASK - HARD
    elif singleconditionsx == 4:
        p01 = .38#(62/38) JDTASK - HARD
    ...
    while continueRoutine:
        ...
        if pcounter <= 500:
            if event.getKeys(keyList=["z"]):
                ...
                if singleconditionsx is 30 or singleconditionsx is 10:
                    win.flip()
                    correct_res.draw()
                    win.flip()
                    core.wait(1.5) # Keep the cross on screen for 2 seconds
                ...
                if singleconditionsx is 20 or singleconditionsx is 40:
                    win.flip()
                    correct_res.draw()
                    win.flip()
                    core.wait(1.5) # Keep the cross on screen for 2 seconds

...
##############
gamble_texti = ''' Gamble... '''
gamble_text = visual.TextStim(win, text=gamble_texti,pos=(0.0, 0.0), height=textsize,wrapWidth=40,alignHoriz = 'center')

continue_trial_texti = ''' Now the trial will continue... '''
...
for j in range(numtrials): # 
    ...
    while continueRoutine:
        ...
        # Set a clock here to keep track of time to show stimulus for before gamble: 
...
pcounternew = 1 #
pcounternew2 = 0 #
# Counter to determine when to show gamble text:
show_gamble = 0
...
for j in range(numtrials): # 
    ...
    if show_gamble == 1:
        ...
        while continueRoutine:
            ...
            # Set a timer now to start keeping track of time for responses: 
            outtimer = tot.getTime()
...
########################################################################################
########################################################################################
# Single Grid Trials - JUDGING DIFFICULTY - BLOCK 4:
########################################################################################
########################################################################################
########################################################################################

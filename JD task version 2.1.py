    ...
    while continueRoutine:
        ...
        # For experimental trials:
            ...
            if event.getKeys(keyList=["z"]): # HARD key
                ...
                if singleconditionsx is 3 or singleconditionsx is 4 or singleconditionsx is 7 or singleconditionsx is 8:
            ...
            if event.getKeys(keyList=["m"]): # EASY key
                ...
                if singleconditionsx is 1 or singleconditionsx is 2 or singleconditionsx is 5 or singleconditionsx is 6:
                    correctresponse2.append('1')
                else:
                    correctresponse2.append('0')
                # Append which colour question was being asked:
...
#            #strialtexto.draw()
        ...
        if event.getKeys(keyList=["z"]): # HARD key
            ...
            if singleconditionsx is 3 or singleconditionsx is 4 or singleconditionsx 7 or singleconditionsx 8:
...
#               fout.write('\n')
        ...
        if event.getKeys(keyList=["m"]): # EASY key
            ...
            if singleconditionsx is 1 or singleconditionsx is 2 or singleconditionsx 5 or singleconditionsx 6:
                correctresponse4.append('0')
            else:
                correctresponse4.append('1')
            # Append which colour question was being asked:

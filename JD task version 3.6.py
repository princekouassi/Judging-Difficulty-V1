...
hst = 50 # How many single trials
p_trial = 1 # Number of practice trials
...
section2prac = '''During this experiment you will need to perform two types of judgements. Firstly, you will be required to stake a set amount of points on getting the task question correct. You will then need to determine whether there are more blue or orange patches in a square grid presented to you. An example of these grids is shown below.'''
section2practice22i = visual.TextStim(win, text=section2prac,pos=(0.0, 10), height=textsize,wrapWidth=40,alignHoriz = 'center')
one111t = '''Observe the grids on the bottom left and right for a few seconds. For the grid on the left or right, you may be asked to answer the following question: Are there more blue than orange patches in the grid? Press "z" for YES or "m" or NO.'''
section2practice22ii = visual.TextStim(win, text=one111t,pos=(-0.8, 6), height=textsize,wrapWidth=40,alignHoriz = 'center') 
one1112t = '''Throughout the experiment you will first need to stake a set amount of points on getting the task question correct, after having seen the square grid for some time. You will then be asked to provide an answer to the task question.'''
section2practice22iii = visual.TextStim(win, text=one1112t,pos=(-0.4, 2), height=textsize,wrapWidth=40,alignHoriz = 'center') 
...
##################################################
# Practice text for ORANGE tirals block 1:
practice01 = '''PRACTICE TRIALS will now begin. For these practice trials you be shown a blue and orange square grid for a short amount of time. After which you must stake a set amount of 50 points allocated to you on each trial, on getting the following question correct: Does the grid have more Orange than Blue Patches? Press "z" for YES or "m" for NO. You will then be shown the sqaure grid again, after some time you will then have to provide an answer to the question and be given feedback.'''
practicetext1 = visual.TextStim(win, text=practice01,pos=(0.0, 3), height=textsize,wrapWidth=40,alignHoriz = 'center') 
# Practice text for BLUE tirals block 1:
practice01b = '''PRACTICE TRIALS will now begin. For these practice trials you be shown a blue and orange square grid for a short amount of time. After which you must stake a set amount of 50 points allocated to you on each trial, on getting the following question correct: Does the grid have more Blue than Orange Patches? Press "z" for YES or "m" for NO. You will then be shown the sqaure grid again, after some time you will then have to provide an answer to the question and be given feedback.'''
practicetext1b = visual.TextStim(win, text=practice01b,pos=(0.0, 3), height=textsize,wrapWidth=40,alignHoriz = 'center') 
# Practice text for ORANGE tirals block 2:
practice01_2 = '''PRACTICE TRIALS will now begin. For these practice trials you be shown a blue and orange square grid for a short amount of time. After which you must stake a set amount of 50 points allocated to you on each trial, on getting the following question correct: Does the grid have more Orange than Blue Patches? Press "z" for YES or "m" for NO. Immediately after you will have to provide an answer to the question. After this you will be shown the square grid for some more time and be given feedback.'''
practicetext1_2 = visual.TextStim(win, text=practice01_2,pos=(0.0, 3), height=textsize,wrapWidth=40,alignHoriz = 'center') 
# Practice text for BLUE tirals block 2:
practice01b_2 = '''PRACTICE TRIALS will now begin. For these practice trials you be shown a blue and orange square grid for a short amount of time. After which you must stake a set amount of 50 points allocated to you on each trial, on getting the following question correct:  Does the grid have more Blue than Orange Patches? Press "z" for YES or "m" for NO. Immediately after you will have to provide an answer to the question. After this you will be shown the square grid for some more time and be given feedback.'''
practicetext1b_2 = visual.TextStim(win, text=practice01b_2,pos=(0.0, 3), height=textsize,wrapWidth=40,alignHoriz = 'center') 
# Practice text for ORANGE tirals block 3:
practice01_3 = '''PRACTICE TRIALS will now begin. For these practice trials you be shown a blue and orange square grid for a short amount of time. After which you must stake a set amount of 50 points allocated to you on each trial, on getting the following question correct: Does the grid have more Orange than Blue Patches? Press "z" for YES or "m" for NO. You will then need to provide an answer to the question, after which you will immediately be given feedback.'''
practicetext1_3 = visual.TextStim(win, text=practice01_3,pos=(0.0, 3), height=textsize,wrapWidth=40,alignHoriz = 'center') 
# Practice text for BLUE tirals block 3:
practice01b_3 = '''PRACTICE TRIALS will now begin. For these practice trials you be shown a blue and orange square grid for a short amount of time. After which you must stake a set amount of 50 points allocated to you on each trial, on getting the following question correct:  Does the grid have more Blue than Orange Patches? Press "z" for YES or "m" for NO. You will then need to provide an answer to the question, after which you will immediately be given feedback.'''
practicetext1b_3 = visual.TextStim(win, text=practice01b_3,pos=(0.0, 3), height=textsize,wrapWidth=40,alignHoriz = 'center') 
# Practice text:
...
practicetext17 = visual.TextStim(win, text=practice0199,pos=(-1, -1), height=textsize,wrapWidth=40,alignHoriz = 'center') 
##################################################
...
prac001bf = '''Practice trials have now finished. The next set of trials are the "real" trials. At the start of all subsequent trials you will be allocated 50 points which you can use to stake an amount of on getting the task question correct.'''
endspractice_bf = visual.TextStim(win, text=prac001bf,pos=(0.0,3.5), height=textsize, wrapWidth=30,alignHoriz = 'center')
prac001b1 = '''The next set of trials will have an identical structure to the practice trials just completed. On all subsequent trials you must answer the following question: Does the grid have more Blue than Orange Patches? Press "z" for YES or "m" for NO.'''
endspractice_b1 = visual.TextStim(win, text=prac001b1,pos=(0,0),  height=textsize, wrapWidth=30,alignHoriz = 'center')
prac001b2 = '''Press any key on the keyboard to begin the actual trials...'''
endspractice_b2 = visual.TextStim(win, text=prac001b2,pos=(0.5,-3.5),  height=textsize, wrapWidth=30,alignHoriz = 'center')
# Practice trials for orange
prac001of = '''Practice trials have now finished. The next set of trials are the "real" trials. At the start of all subsequent trials you will be allocated 50 points which you can use to stake an amount of on getting the task question correct.'''
endspractice_of = visual.TextStim(win, text=prac001of,pos=(0.0,3.5), height=textsize, wrapWidth=30,alignHoriz = 'center')
prac001o1 = '''The next set of trials will have an identical structure to the practice trials just completed. On all subsequent trials you must answer the following question: Does the grid have more Orange than Blue Patches? Press "z" for YES or "m" for NO.'''
endspractice_o1 = visual.TextStim(win, text=prac001o1,pos=(0,0), height=textsize, wrapWidth=30,alignHoriz = 'center') 
prac001o2 = '''Press any key on the keyboard to begin the actual trials...'''
endspractice_o2 = visual.TextStim(win, text=prac001o2,pos=(0.0,-3.5), height=textsize, wrapWidth=30,alignHoriz = 'center')
####################################################
####################################################
####################################################
...
# For single grid trials s5
keyspressed5 = []*singletrials
correctresponse5 = []*singletrials
RT5 =[]*singletrials
trialNo5 = []*singletrials
conused5 = []*singletrials
difflevel5 = []*singletrials
colourcolour5 = []*singletrials

# For single grid trials s6
keyspressed6 = []*singletrials
correctresponse6 = []*singletrials
RT6 =[]*singletrials
trialNo6 = []*singletrials
conused6 = []*singletrials
difflevel6 = []*singletrials
colourcolour6 = []*singletrials
...
for j in range(numtrials):
    ...
    if pcounter > 500:
        ...
        if singleconditionsx == 1:
            conused.append('b,o')
            difflevel.append('Hard')
        elif singleconditionsx == 2:
            conused.append('B,o')
            difflevel.append('Mid')
        elif singleconditionsx == 3:
            conused.append('B,O')
            difflevel.append('Easy')
    ...
    # More Blue Trials:
    if singleconditionsx == 1:
        p01 = .50#(50/50) PTASK - HARD
    elif singleconditionsx == 2:
        p01 = .56#(56/44) PTASK - MID
    elif singleconditionsx == 3:
    ...
    # Practice trial conditions:
        ...
        p01 = .56 # (56/44) a lot of orange MID (more orange)
        
        
    print('trial ===', singleconditionsx)
    ...
    if show_gamble == 1:
        ...
        # MAIN EXPERIMENT
        ########################################################################################
        print('trial 2 ===', singleconditionsx)
...
for j in range(numtrials):
    ...
    if pcounter > 500:
        ...
        if singleconditionsx == 1:
            conused2.append('b,o')
            difflevel2.append('Hard')
        elif singleconditionsx == 2:
            conused2.append('B,o')
            difflevel2.append('Mid')
        elif singleconditionsx == 3:
            conused2.append('B,O')
            difflevel2.append('Easy')
        elif singleconditionsx == 4:
            conused2.append('o,b') 
            difflevel2.append('Hard')
        elif singleconditionsx == 5:
    ...
    print('trial3 ===', singleconditionsx)
    ...
    if show_gamble == 1:
        ...
        print('trial4 ===', singleconditionsx)
...
for j in range(numtrials): # 
    ...
    if pcounter > 500:
        ...
        if singleconditionsx == 1:
            conused3.append('b,o')
            difflevel3.append('Hard')
        elif singleconditionsx == 2:
            conused3.append('B,o')
            difflevel3.append('Mid')
        elif singleconditionsx == 3:
            conused3.append('B,O')
            difflevel3.append('Easy')
        elif singleconditionsx == 4:
            conused3.append('o,b') 
            difflevel3.append('Hard')
        elif singleconditionsx == 5:
    ...
    print('trial5 ===', singleconditionsx)
...
########################################################################################
########################################################################################
# BLOCK 4 - JUDGING PROPORTIONS - STAKE -THEN - CHOICE&FEEDBACK:
########################################################################################
########################################################################################
########################################################################################
# Initialize components for Routine "init_experiment"
...
for j in range(numtrials):
    ...
    if pcounter > 500:
        ...
        if singleconditionsx == 1:
            conused4.append('b,o')
            difflevel4.append('Hard')
        elif singleconditionsx == 2:
            conused4.append('B,o')
            difflevel4.append('Mid')
        elif singleconditionsx == 3:
            conused4.append('B,O')
            difflevel4.append('Easy')
        elif singleconditionsx == 4:
            conused4.append('o,b') 
            difflevel4.append('Hard')
        elif singleconditionsx == 5:
    ...
    print('trial6 ===', singleconditionsx)
    ...
    if show_gamble == 1:
        ...
        # MAIN EXPERIMENT
        ########################################################################################
        print('trial7 ===', singleconditionsx)
...
########################################################################################
########################################################################################
# BLOCK 5 - JUDGING PROPORTIONS - STAKE&CHOICE - THEN - FEEBACK:
########################################################################################
########################################################################################
########################################################################################
# Initialize components for Routine "init_experiment"
...
for j in range(numtrials):
    ...
    if pcounter > 500:
        ...
        if singleconditionsx == 1:
            conused5.append('b,o')
            difflevel5.append('Hard')
        elif singleconditionsx == 2:
            conused5.append('B,o')
            difflevel5.append('Mid')
        elif singleconditionsx == 3:
            conused5.append('B,O')
            difflevel5.append('Easy')
        elif singleconditionsx == 4:
            conused5.append('o,b') 
            difflevel5.append('Hard')
        elif singleconditionsx == 5:
    ...
    print('trial8 ===', singleconditionsx)
        ...
        if outtimer > 0.5:
            ...
            if keypressed == ["z"]: # MORE key
                ...
                if pcounter > 500:
                    if colour_order1 == 1:
                        if singleconditionsx <= 3:
                            correctresponse5.append('1')
                            right_key = 1
                        elif singleconditionsx >= 4:
                            correctresponse5.append('0')
                            right_key = 0
                    elif colour_order1 == 2:
                        if singleconditionsx <= 3:
                            correctresponse5.append('0')
                ...
                if pcounter > 500:
                    # Append which colour question was being asked:
                    colourcolour5.append(colour_order1)
                
                if pcounter > 500:
                    # Keep track of keys pressed
                    keyspressed5.append('left')
    ...
    if show_gamble == 1:
        ...
        print('trial9 ===', singleconditionsx)
...
########################################################################################
########################################################################################
# BLOCK 6 - JUDGING PROPORTIONS - STAKE&CHOICE&FEEBACK:
########################################################################################
########################################################################################
########################################################################################
# Initialize components for Routine "init_experiment"
...
for j in range(numtrials): # 
    ...
    if pcounter > 500:
        ...
        if singleconditionsx == 1:
            conused6.append('b,o')
            difflevel6.append('Hard')
        elif singleconditionsx == 2:
            conused6.append('B,o')
            difflevel6.append('Mid')
        elif singleconditionsx == 3:
            conused6.append('B,O')
            difflevel6.append('Easy')
        elif singleconditionsx == 4:
            conused6.append('o,b') 
            difflevel6.append('Hard')
        elif singleconditionsx == 5:
    ...
    print('trial10 ===', singleconditionsx)
        ...
        if outtimer > 1.5:
            ...
            if keypressed == ["z"]: # MORE key
                ...
                if pcounter > 500:
                    if colour_order1 == 1:
                        if singleconditionsx <= 3:
                            correctresponse6.append('1')
                            win.flip()
                            correct_res.draw()
                            win.flip()
                            core.wait(1.5) # Keep the cross on screen for 2 seconds
                        elif singleconditionsx >= 4:
                            correctresponse6.append('0')
                            win.flip()
                            incorrect_res.draw()
                            win.flip()
                            core.wait(1.5) # Keep the cross on screen for 2 seconds
                ...
                if pcounter > 500:
                    # Append which colour question was being asked:
                    colourcolour6.append(colour_order1)
                
                if pcounter > 500:
                    # Keep track of keys pressed
                    keyspressed6.append('left')
                ...
                if counter01 == hst:
                   ...
                   #fout.write('\n')
                    for i in range(hst):
                        ...
                        fout.write('%s\t'% gamble_b4[i],)
                        fout.write('%s\t\n'% colourcolour4[i],)
                        
                    #fout.write('\n')
                    for i in range(hst):
                        fout.write('%d\t'% trialNo5[i],)
                        fout.write('%s\t'% correctresponse5[i],)
                        fout.write('%.3f\t'% RT5[i],)
                        fout.write('%s\t'% conused5[i],)
                        fout.write('%s\t'% difflevel5[i],)
                        fout.write('%s\t'% gamble_b5[i],)
                        fout.write('%s\t\n'% colourcolour5[i],)
                        
                    #fout.write('\n')
                    for i in range(hst):
                        fout.write('%d\t'% trialNo6[i],)
                        fout.write('%s\t'% correctresponse6[i],)
                        fout.write('%.3f\t'% RT6[i],)
                        fout.write('%s\t'% conused6[i],)
                        fout.write('%s\t'% difflevel6[i],)
                        fout.write('%s\t'% gamble_b6[i],)
                        fout.write('%s\t\n'% colourcolour6[i],)

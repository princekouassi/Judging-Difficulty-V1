...
section2prac = '''During this experiment you will have to perform two types of judgements. Some trials you will be requiref to determine whether there are more blue or orange patches in a grid. Other trials will require you to judge if determining whether there are more blue or orange patches in a grid is easy or hard. Example grids are shown below. '''
...
practice01r = '''Practice trials: Does the grid have more Orange than Blue Patches? Press "z" for YES or "m" for NO.'''
...
practicetext12 = visual.TextStim(win, text=practice012,pos=(0,3), height=textsize) 
# Practice text:
practice01992 = '''Press any key on the keyboard to begin the practice trials...'''
practicetext172 = visual.TextStim(win, text=practice01992,pos=(-0.5,-0.5), height=textsize)
###################################################
...
for j in range(numtrials): # 
    ...
    if singleconditionsx == 1:
        ...
        p01 = .80 # a lot of orange
    elif singleconditionsx == 20:
        p01 = .20 # a lot of blue
...
for j in range(numtrials): # 
    ...
    if singleconditionsx == 1:
        ...
        p01 = .52 # a little more of orange
    elif singleconditionsx == 40:
        p01 = .48 # a little more of blue
    ...
    while continueRoutine:
        ...
        if pcounter <= 500:
            if event.getKeys(keyList=["z"]):
                ...
                if singleconditionsx is 30 or singleconditionsx is 40:
                    win.flip()
                    correct_res.draw()
                    win.flip()
                    core.wait(1.5) # Keep the cross on screen for 2 seconds
                ...
                if singleconditionsx is 10 or singleconditionsx is 20:
                    win.flip()
                    correct_res.draw()
                    win.flip()
                    core.wait(1.5) # Keep the cross on screen for 2 seconds
        ...
        # For experimental trials:
            ...
            if event.getKeys(keyList=["z"]): # MORE key
                ...
                if singleconditionsx is 1 or singleconditionsx is 3:

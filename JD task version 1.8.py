...
for j in range(numtrials): # 
    ...
    if singleconditionsx == 1:
        ...
        p01 = .70 # a lot of orange
    elif singleconditionsx == 20:
        p01 = .40 # a lot of blue
    elif singleconditionsx == 30:
        p01 = .60 # a lot of orange
...
for j in range(numtrials): # 
    ...
    if pcounter > 500:
        ...
        if singleconditionsx == 1:
            ...
            conused2.append('b,o')
            difflevel2.append('Exp - Hard 2')
        elif singleconditionsx == 6:
            conused2.append('B,o')
            difflevel2.append('Con - Easy 2')
    ...
    if singleconditionsx == 1:
        ...
        p01 = .52#(52/48) more orange
    elif singleconditionsx == 4:
        p01 = .70#(70/30) a lot more orange
    elif singleconditionsx == 5:
        p01 = .42#(58/42) more blue
    elif singleconditionsx == 6:
        p01 = .38#(62/38) a lot more blue
    elif singleconditionsx == 7:
        p01 = .58#(58/42) more orange
    elif singleconditionsx == 8:
        p01 = .62#(62/38) a lot more orange
...
for j in range(hst):
    ...
    if pcounter > practicetrials:
        ...
        if singleconditionsx == 1:
            ...
            conused4.append('b,o')
            difflevel4.append('Exp - Hard 2')
        elif singleconditionsx == 6:
            conused4.append('B,o')
            difflevel4.append('Con - Easy 2')
        elif singleconditionsx == 7:
            conused4.append('o,b')
            difflevel4.append('Exp - Hard 2')
        elif singleconditionsx == 8:

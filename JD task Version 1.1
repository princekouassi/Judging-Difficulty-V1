...
singletrials = 5     # **Number of single grid trials per colour_order block which should be set to 40 in the real experiment**
...
#            #strialtexto.draw()
        ...
        if event.getKeys(keyList=["z"]): # MORE key
            ...
            if counter01s2 == singletrials:
                ...
                fout.write('Trial Number, Response, Correct/Incorrect(1/0), RT, Condition, Difficulty, Seperation (ONLY FOR PAIRD GRID TRIALS 1=close 2=far)\n')

...
#############################
displaystim_texti = " Make a decision now"
    ...
    while continueRoutine:
        ...
        ##########################################################################
            ...
            if outtimer > 1.0:
                ...
                win.flip()
                keypressed = event.waitKeys(keyList=["escape","6","z","m"])
                print('key pressed after gamble =====', keypressed)
                # For experimental trials:
                # RESPONSE 1:
                if keypressed == ["escape"]:
                    win.flip()
        ...
        while continueRoutine:
            ...
            if pcounter > theline:
                ...
                if display_timer > 1.5:
                    ...
                    feedback_text.draw()
                    win.flip()
                    keypressed = event.waitKeys(keyList=None)
...
print('LAST KEY PRSSED =====', keypressed)
...
for j in range(numtrials): # 
    ...
    print('last practice count ===', practicecount)
